(function (global, factory) {
    ...
    var ShebaService = /** @class */ (function () {
        ...
        ShebaService.prototype.isValid = function (str) {
            if (str.length !== 26) {
                return false;
            }
        ...
        ShebaService.prototype.recognize = function (str) {
            if (!this.isValid(str)) {
                return false;
            }
        ...
        ShebaService.decorators = [
            { type: core.Injectable },
        ];
        /** @nocollapse */
        ShebaService.ctorParameters = function () { return []; };
        return ShebaService;
    }());

    var ShebaModule = /** @class */ (function () {
        function ShebaModule() {
        }
        ShebaModule.decorators = [
    ...
    exports.ShebaModule = ShebaModule;
    exports.ShebaService = ShebaService;
